function Edit() {
  return (
    <div className="flex justify-around">
      <div
        id="1"
        className="mt-2 bg-gris w-24 h-24 justify-center items-center flex flex-wrap border border-noir"
      >
        <select
          className="outline-none appearance-none bg-gris w-full h-full flex text-center"
          id="genre"
          name="genre"
        >
          <option className="bg-noir text-white" value="genre1">
            Masculin
          </option>
          <option className="bg-noir text-white" value="genre2">
            Feminin
          </option>
        </select>
      </div>
      ...
      >
        <select
          ...
          name="race"
        >
          <option className="bg-noir text-white" value="race1">
            Race 1
          </option>
          <option className="bg-noir text-white" value="race2">
            Race 2
          </option>
          <option className="bg-noir text-white" value="race3">
            Race 3
          </option>
        </select>
      </div>
      ...
      >
        <select
          ...
          name="classe"
        >
          <option className="bg-noir text-white" value="classe1">
            Classe 1
          </option>
          <option className="bg-noir text-white" value="classe2">
            Classe 2
          </option>
          <option className="bg-noir text-white" value="classe3">
            Classe 3
          </option>
        </select>
      </div>
      <div
        id="4"
        className="mt-2 bg-gris w-80 h-fit justify-around flex flex-wrap border border-noir"
      >
        <div className="w-72 h-24 p-2 border border-noir m-1 flex justify-center left-0">
          <input
            className="bg-gris flex text-center flex-col justify-center items-center outline-none"
        ...
        <div className="bg-[url('/casque.png')] bg-contain w-24 h-24 p-2 border border-noir m-1 flex justify-center">
          <label htmlFor="casque"></label>
          <select
            className="outline-none appearance-none bg-transparent text-white"
            id="casque"
            name="casque"
          >
            <option className="bg-noir" value="casque1">
              Casque 1
            </option>
            <option className="bg-noir" value="casque2">
              Casque 2
            </option>
            <option className="bg-noir" value="casque3">
              Casque 3
            </option>
          </select>
        </div>
