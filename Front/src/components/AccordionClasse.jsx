...
const AccordionClasse = (props) => {
  ...
  useEffect(() => {
    fetch(`http://127.0.0.1:3000/api/classe/name/${props.classe}`, {
      method: "GET",
      headers: {
  ...
  return (
    <div id="accordion-open" data-accordion="open">
      ...
      >
        <div className="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900"></div>
      </div>
    </div>
  );
};

export default AccordionClasse;
